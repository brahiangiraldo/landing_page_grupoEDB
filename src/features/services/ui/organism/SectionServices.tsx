...
const SectionServices = () => {
  const itemCards: ICards[] = [
    {
      icon: <IconFinance color="#3398ff" height={ 138 } width={ 154 } />,
      title: 'Finances',
    ...
    {
      icon: <IconDevices color="#3398ff" height={ 138 } width={ 154 } />,
    ...
    {
      icon: <IconCode color="#3398ff" height={ 120 } width={ 124 } />,
      title: 'Development',
    ...
    {
      icon: <IconChat color="#3398ff" height={ 138 } width={ 154 } />,
      title: 'Call Center',
