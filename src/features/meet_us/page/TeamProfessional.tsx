...
import ResumePoints from '../moleculas/resume_Points/ResumePoints';
import ResumeProfessional from '../moleculas/resume_Professional/ResumeProfessional';
import Connecting from '../organism/connecting/Connecting';
